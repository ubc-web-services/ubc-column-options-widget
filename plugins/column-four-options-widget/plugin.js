'use strict';
(function () {
  CKEDITOR.plugins.add('column-four-options-widget', {
    requires: 'widget',
    icons: 'column-four-options-widget',
    init: function (editor) {
      // Register the editing dialog.
      CKEDITOR.dialog.add('column-four-options-widget', this.path + 'dialogs/column-four-options-widget.js');
      editor.addContentsCss(this.path + 'css/column-four-options-widget.css');
      editor.ui.addButton('column-four-options-widget', {
        label: 'Insert Columns with options',
        icon: this.path + 'icons/column-four-options-widget.png',
        command: 'column-four-options-widget'
      });

      editor.widgets.add('column-four-options-widget', {
        ...
        dialog: 'column-four-options-widget',
