'use strict';
(function () {
  CKEDITOR.plugins.add('column-three-options-widget', {
    requires: 'widget',
    icons: 'column-three-options-widget',
    init: function (editor) {
      // Register the editing dialog.
      CKEDITOR.dialog.add('column-three-options-widget', this.path + 'dialogs/column-three-options-widget.js');
      editor.addContentsCss(this.path + 'css/column-three-options-widget.css');
      editor.ui.addButton('column-three-options-widget', {
        label: 'Insert Columns with options',
        icon: this.path + 'icons/column-three-options-widget.png',
        command: 'column-three-options-widget'
      });

      editor.widgets.add('column-three-options-widget', {
        ...
        dialog: 'column-three-options-widget',
